...
namespace MoreMountains.NiceVibrations
{
    ...
    public class MMNVBuildPostProcessor : IPostprocessBuildWithReport
    {
        ...
        public static string GetPluginPath()
        {
                ...
                string path = res[0].Replace("MMNVBuildPostProcessor.cs", "").Replace("\\", SEPARATOR.ToString());
                ...
                finalPath = finalPath.Replace("//", SEPARATOR.ToString());
        ...
        public static void ConfigureXCodeProjectForNativePlugin(string xcodeProjectPath)
        {
            ...
            bool alsoWriteToMainProject = false;
            if (pathDefinition != null)
            {
                ...
                alsoWriteToMainProject = pathDefinition.AlsoWriteToMainProject;
            }
            ...
            pbxProject.ReadFromString(File.ReadAllText(pbxProjectPath));
                ...
                if (alsoWriteToMainProject)
                {
                    targetGUID = pbxProject.GetUnityMainTargetGuid();
                    WritePropertiesToMainTarget(pbxProject, targetGUID, pbxProjectPath, pluginPath, forceAlwaysEmbedSwiftStandardLibraries);
                }
